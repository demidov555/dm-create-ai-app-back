...
4. 🎨 UI / UX требования
5. 🚫 Ограничения и нецели (Out of Scope)
...
def _output_format_block(role: str) -> str:
    # ЕДИНЫЙ формат для всех: 2 строки, без markdown
    return (
...
def generate_agent_prompt(specification: str, role: str) -> str:
    # specification тут должен быть ЧИСТЫЙ JSON-контракт (без ```), как ты уже делаешь через _strip_json_fences
    return (
